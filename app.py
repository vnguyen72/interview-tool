...
st.set_page_config(page_title="Streamlit Chat", page_icon=":smile") 
st.title("Chatbot")
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
   ...
   if "openai_model" not in st.session_state:
      st.session_state["openai_model"] = "gpt-5.4"

   if not st.session_state.messages:
      st.session_state.messages = [{
         "role": "system", 
         "content": (f"You are an HR executive that interviews an interviewee call {st.session_state["name"]} "
